...
git checkout master passing tests: "git checkout master-passing-tests\n"
...
git fetch master passing tests: "git fetch origin master-passing-tests\n"
git fetch originmaster passing tests: "git fetch origin master-passing-tests\n"
...
git pull master passing tests: "git pull origin master-passing-tests\n"
git pull origin master passing tests: "git pull origin master-passing-tests\n"
...
git rebase master passing tests: "git rebase -i origin/master-passing-tests\n"
